    ...
    obterVerificacoesGovernoMt() {
        ...
        if (this.#valor < 1) {
            btn_min_parana.innerHTML =
                `<button type="button" title="SALDO MIN&Iacute;MO - R$ 1"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
                <span class="btn-inner--icon"><i
                class="fas fa-times"></i></span>
                <span class="btn-inner--text">NEGADO</span>
        ...
        if(this.#valor < 200) {
            btn_min_pan.innerHTML =
                `<button type="button" title="SALDO MIN&Iacute;MO - R$ 200,00"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
                <span class="btn-inner--icon"><i
                class="fas fa-times"></i></span>
                <span class="btn-inner--text">NEGADO</span>
