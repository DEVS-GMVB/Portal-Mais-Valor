class PrefeituraTaboao {
    ...
    obterVerificacoesPrefeituraTaboao() {
        //Botões Santander
        ...
        } else if ((this.#dataDias >= 27717 && this.#dataDias < 29176) && this.#valor > 100000 ) {
            btn_max_bradesco.innerHTML =
                `<button type="button"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
            <span class="btn-inner--icon"><i
        ...
        if (this.#valor < 30) {
            btn_min_bradesco.innerHtml =
                `<button type="button" title="SALDO MINÍMO - R$ 30"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
            <span class="btn-inner--icon"><i
            class="fas fa-times"></i></span>
            <span class="btn-inner--text">NEGADO</span>
        ...
        if (this.#valor < 1) {
            btn_min_parana.innerHTML =
                `<button type="button" title="SALDO MINÍMO"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
                <span class="btn-inner--icon"><i
                class="fas fa-times"></i></span>
                <span class="btn-inner--text">NEGADO</span>
        ...
        //Quantidade de parcelas
        if (this.#qtdParcelas > 48 || this.#qtdParcelas < 2) {
            btn_parcelas_bb.innerHTML =
                `<button type="button" title="PARCELA ACIMA DE 48X OU ABAIXO DE 2X"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
                <span class="btn-inner--icon"><i
                class="fas fa-times"></i></span>
                <span class="btn-inner--text">NEGADO</span>
...
export default PrefeituraTaboao;