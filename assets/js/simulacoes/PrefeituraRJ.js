class PrefeituraRJ {
    ...
    obterVerificacoesPrefeituraRJ() {
        ...
        //Quantidade parcelas
        if (this.#qtdParcelas.value > 144 || this.#qtdParcelas.value < 3) {
        ...
        if (this.#valor > 50000) {
            ...
            `<button type="button" title="Saldo maximo de R$ 50.000,00"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
                <span class="btn-inner--icon"><i
                class="fas fa-times"></i></span>
                <span class="btn-inner--text">NEGADO</span>
       ...
       if ((this.#dataDias >= 6911 && this.#dataDias < 25526) && this.#valor > 250000) {
        ...
        if(this.#valor < 200) {
            btn_min_pan.innerHTML =
                `<button type="button" title="saldo maximo R$ 200,00"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
                <span class="btn-inner--icon"><i
                class="fas fa-times"></i></span>
                <span class="btn-inner--text">NEGADO</span>
        ...
        //Quantidade de parcelas
        if (this.#qtdParcelas > 144 || this.#qtdParcelas < 2) {
