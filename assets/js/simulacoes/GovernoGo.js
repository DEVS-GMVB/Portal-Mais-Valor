    ...
    obterVerificacoesGovernoGo() {
        ...
        if (this.#qtdParcelas.value > 96 || this.#qtdParcelas.value < 3) {
            btn_parcelas_sant.innerHTML =
                `
            <button type="button" title="maior que 96 parcelas ou menor que 3"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
                <span class="btn-inner--icon"><i
                class="fas fa-times"></i></span>
                <span class="btn-inner--text">NEGADO</span>
        ...
        if(this.#valor > 200000) {
            ...
            `
            <button type="button" title="Saldo maximo R$ 200.000,00"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
                <span class="btn-inner--icon"><i
                class="fas fa-times"></i></span>
                <span class="btn-inner--text">NEGADO</span>
        ...
        if(this.#valor < 300) {
            ...
            `
            <button type="button" title="Saldo mínimo R$ 300,00"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
                <span class="btn-inner--icon"><i
                class="fas fa-times"></i></span>
                <span class="btn-inner--text">NEGADO</span>
        ...
        if ((this.#dataDias >= 6911 && this.#dataDias < 25526) && this.#valor > 250000) {
            btn_max_bradesco.innerHTML =
                `<button type="button"  title="De 21 a 69 anos e 11 meses R$ 250.000,00
                De 70 a 74 anos e 11 meses R$ 50.000,00"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
            <span class="btn-inner--icon"><i
            class="fas fa-times"></i></span>
            <span class="btn-inner--text">NEGADO</span>
        ...
        if (this.#valor < 30) {
            btn_min_bradesco.innerHtml =
                `<button type="button" title="saldo minimo de R$ 30,00"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
            <span class="btn-inner--icon"><i
            class="fas fa-times"></i></span>
            <span class="btn-inner--text">NEGADO</span>
        ...
        if (this.#qtdParcelas > 96 && this.#qtdParcelas < 25) {
