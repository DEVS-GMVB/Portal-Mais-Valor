class PrefeituraCampoGrande {
    ...
    obterVerificacoesPrefeituraCampoGrande() {
        //Botões Santander
        ...
        //Quantidade parcelas
        if (this.#qtdParcelas.value > 90 || this.#qtdParcelas.value < 3) {
        ...
        if (this.#valor > 230000) {
            btn_max_ole.innerHTML =
                ...
                De 18 a 59 anos e 11 meses R$ 230.000,00
       ...
       if ((this.#dataDias >= 27372 && this.#dataDias < 27716) && this.#qtdParcelas > 60 && this.#valor > 30000) {
        ...
        if (this.#valor > 100000) {
            btn_max_bb.innerHTML =
                `<button type="button" title="De 21 a 64 anos e 11 meses R$ 100.000,00
                "
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
                <span class="btn-inner--icon"><i
                class="fas fa-times"></i></span>
...
export default PrefeituraCampoGrande;