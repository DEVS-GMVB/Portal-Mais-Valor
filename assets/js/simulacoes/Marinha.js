class Marinha {
    ...
    obterVerificacoesMarinha() {
        ...
        if(this.#valor > 200000) {
            ...
            `
            <button type="button" itle="De 18 anos a 69 anos 11 meses 29 dias R$ 300.000,00 - M&Aacute;X PARC: 96 meses
            De 70 anos a 75 anos 11 meses 29 dias R$ 200.000,00 - M&Aacute;X PARC: 96 meses"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
                <span class="btn-inner--icon"><i
                class="fas fa-times"></i></span>
                <span class="btn-inner--text">NEGADO</span>
        ...
        if (this.#qtdParcelas > 72) {
            btn_parcelas_bradesco.innerHTML =
                ...
                R$ 70.000,00 - M&Aacute;X PARC: 84 meses
                
                De 61 anos a 65 anos 11 meses 29 dias 
                R$ 60.000,00 - M&Aacute;X PARC: 84 meses
                
                De 66 anos a 70 anos 11 meses 29 dias 
                R$ 50.000,00 - M&Aacute;X PARC: 84 meses
                
                De 71 anos a 75 anos 11 meses 29 dias 
                R$ 25.000,00 - M&Aacute;X PARC: 84 meses"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
            <span class="btn-inner--icon"><i
            class="fas fa-times"></i></span>
            <span class="btn-inner--text">NEGADO</span>
        ...
        if ((this.#dataDias >= 6911 && this.#dataDias < 25526) && this.#valor > 300000) {
            btn_max_bradesco.innerHTML =
                ...
                R$ 300.000,00 - M&Aacute;X PARC: 96 meses
                
                De 70 anos a 75 anos 11 meses 29 dias 
                R$ 200.000,00 - M&Aacute;X PARC: 96 meses"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
            <span class="btn-inner--icon"><i
            class="fas fa-times"></i></span>
            <span class="btn-inner--text">NEGADO</span>
        ...
        if (this.#valor < 0) {
            btn_min_bradesco.innerHtml =
                `<button type="button" title="SALDO MIN&Iacute;MO - R$ 900,01"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
            <span class="btn-inner--icon"><i
            class="fas fa-times"></i></span>
            <span class="btn-inner--text">NEGADO</span>
        ...
        if (this.#dataDias > 28446) {
            btn_idade_parana.innerHTML =
                `<button type="button" title="Terminar o contrato com (73 ANOS 11 MESES 29 DIAS)"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
            <span class="btn-inner--icon"><i
            class="fas fa-times"></i></span>
            <span class="btn-inner--text">NEGADO</span>
        ...
        if (this.#qtdParcelas > 72) {
            btn_parcelas_parana.innerHTML =
                `<button type="button" title="parcelas maiores do que 72"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
                <span class="btn-inner--icon"><i
                class="fas fa-times"></i></span>
                <span class="btn-inner--text">NEGADO</span>
        ...
        if (this.#valor > 50000) {
            ...
            `<button type="button" title="saldo máximo de R$ 50.000,00"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
                <span class="btn-inner--icon"><i
                class="fas fa-times"></i></span>
                <span class="btn-inner--text">NEGADO</span>
        ...
        if ((this.#dataDias >= 24431 && this.#dataDias < 27716) && this.#qtdParcelas > 72 && this.#valor > 200000) {
            ...
            De 22 anos a 65 anos 11 meses 29 dias M&Aacute;X PARC: 96 meses
            De 66 anos a 70 anos 11 meses 29 dias R$ 80.000,00 - M&Aacute;X PARC: 96 meses
            De 71 anos a 75 anos 11 meses 29 dias R$ 50.000,00 - M&Aacute;X PARC: 60 meses
            De 76 anos a 79 anos 11 meses 29 dias R$ 8.000,00 - M&Aacute;X PARC: 12 meses"
            class="btn btn-sm btn-soft-danger btn-icon rounded-pill">
                <span class="btn-inner--icon"><i
                class="fas fa-times"></i></span>
                <span class="btn-inner--text">NEGADO</span>
