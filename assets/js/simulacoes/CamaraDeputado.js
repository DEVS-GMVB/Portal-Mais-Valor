class CamaraDeputado {
    ...
    obterVerificacoesCamaraDeputado() {
        //Botões Santander
        ...
        //Saldo maximo
        if ((this.#dataDias >= 6911 && this.#dataDias < 25526) && this.#valor > 400000 && this.#qtdParcelas > 96) {
            btn_max_bradesco.innerHTML =
                `<button type="button" title="DE 18 A 69 ANOS 11 MESES E 29 DIAS R$ 400.000,00 MAX PARC 96 
                DE 70 A 75 ANOS 11 MESES E 29 DIAS R$ 150.000,00 MAX  PARC 96
        ...
        } else if ((this.#dataDias >= 25527 && this.#dataDias < 27716) && this.#valor > 150000 && this.#qtdParcelas > 96) {
            btn_max_bradesco.innerHTML =
                `<button type="button" title="DE 18 A 69 ANOS 11 MESES E 29 DIAS R$ 400.000,00 MAX PARC 96 
                DE 70 A 75 ANOS 11 MESES E 29 DIAS R$ 150.000,00 MAX  PARC 96
                DE 76 A 76 ANOS 11 MESES E 29 DIAS R$ 100.000,00 MAX PARC 48
        ...
        //Saldo maximo
        if ((this.#dataDias >= 8371 && this.#dataDias < 24066) && this.#valor > 400000 && this.#qtdParcelas > 96) {
            btn_max_pan.innerHTML =
                `<button type="button" title="
                DE 22 A 65 ANOS 11 MESES E 29 DIAS R$ 400.000,00   MAX PARC 96
                DE 66 A 72 ANOS 11 MESES E 29 DIAS R$ 150.000,00 MAX  PARC 96
        ...
        }else if ((this.#dataDias >= 24067 && this.#dataDias < 26621) && this.#valor > 150000 && this.#qtdParcelas > 96) {
                btn_max_pan.innerHTML =
                    `<button type="button" title="
                    DE 22 A 65 ANOS 11 MESES E 29 DIAS R$ 400.000,00   MAX PARC 96
                    DE 66 A 72 ANOS 11 MESES E 29 DIAS R$ 150.000,00 MAX  PARC 96
